...
# ----------------------------------------------------- 
config_file=$(cat ~/nix/home-manager/modules/hyprland.nix)
...
sleep 0.2
rofi -dmenu -i -markup -eh 2 -replace -p "Keybinds" -config ~/nix/home-manager/modules/rofi/ml4w/config-compact.rasi <<< "$keybinds"
